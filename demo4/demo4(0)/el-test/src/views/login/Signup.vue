<template>
  <div class="SignupPage-box-content">
    ...
    <div class="Signup-phoneNumber">
      <el-select v-model="value" class="Signup-phoneNumber-select">
        <el-option
      ...
      <input type="text" class="Input" :value="user.phoneNumber" placeholder="手机号" />
      <div class="Signup-errorTip-hidden">请输入手机号</div>
    </div>
    <div class="Signup-verifyCode">
      <input type="text" class="Input" :value="user.verifyCode" placeholder="请输入6位短信验证码" />
    ...
    <div>
      <el-button type="primary" class="Login" size="medium">注册/登录</el-button>
    </div>
  </div>
</template>
