    ...
    <div id="root">
        ...
        <div id="bottom" class="container">
            ...
            <div style="margin-top: 100px;border: 2px dashed black; padding: 20px">
                ...
                <h3>修改后信息：</h3>
                <%--<jsp:useBean id="user" class="com.com.shiina.VO.User" scope="request"></jsp:useBean>--%>
                <jsp:useBean id="userModify" class="com.shiina.VO.User" scope="request" />
                ...
                password： <jsp:getProperty name="userModify" property="password"/><br>
                sex：<jsp:getProperty name="userModify" property="sex"/><br>
                name：<jsp:getProperty name="userModify" property="name"/><br>
                age：<jsp:getProperty name="userModify" property="age"/><br>
                username：<jsp:getProperty name="userModify" property="username"/>
            </div>

            <input type="button" value="重新登陆" id="relogin" onclick="window.location = '../login.jsp?lan=cn'"/>
